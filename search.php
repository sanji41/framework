				...
				<div id="main" class="col700 left first clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
							...
							<p class="meta"><img src="<?php  get_template_directory_uri('template_directory'); ?>/images/calendar.gif" /><?php _e("", "frameworktheme"); ?> 
                           <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time('F jS, Y'); ?></time> 
							<img src="<?php  get_template_directory_uri('template_directory'); ?>/images/person.gif" /><?php _e("", "frameworktheme"); ?> <?php the_author_posts_link(); ?> 
							 <img src="<?php  get_template_directory_uri('template_directory'); ?>/images/bookmark.gif" /> <?php _e("", "frameworktheme"); ?> <?php the_category(', '); ?>.</p>
